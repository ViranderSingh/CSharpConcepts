...
namespace ThreadJoinIsAlive
{
    class Program
    {
        static void Main()
        {
            ...
            //T1.Join();      //First Overload without any parameters
            //Console.WriteLine("Thread1Function completed");
            if (T1.Join(1000))      //Second Overlaod with TimeOut parameter
            {
                Console.WriteLine("Thread1Function completed");
            }
            else
            {
                Console.WriteLine("Thread1Function has not been completed in 1 second");
            }
